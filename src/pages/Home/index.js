...
export default function Home() {
  ...
  return (
    <div>
      <LayoutSidebar sidebar={<SideNav items={menus} verticalAlign="top" active={products.category} onChange={category => dispatch(setCategory(category))} />}
        content={<div className="md:flex md:flex-row-reverse w-full mr-5 h-full min-hscreen">
          <div className="w-full md:w-3/4 pl-5 pb-10">
            <TopBar />

            <div className="w-full md:w-1/2 text-center mb-10 mt-5">
              <InputText
                fullRound
