    ...
    {activeStep === 0 ?
      <div>
        ...
        <div className="text-right">
          ...
          <br />
          <Button onClick={_ => setActiveStep(activeStep + 1)} color="red" iconAfter={<FaArrowRight />}>Selanjutnya</Button>
        </div>
      </div>
      : null}
          ...
          items={[
            {
              label: 'Alamat', value: <div>
                ...
                {selectedAddress.kabupaten}, {selectedAddress.kecamatan},
                {selectedAddress.kelurahan} <br />
